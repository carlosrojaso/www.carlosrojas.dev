    ...
    return html`
      ...
      <section>
        ...
        <ol>
          ...
          <li>
            Made a few super duper popular songs (cooler than me, I took a pill
            in ibiza)
          </li>
          <li>Dyed my hair green for a while</li>
          <li>
            Got nominated for a Grammy…for song of the year!!!! (I didn’t win
            the previously mentioned grammy…Adele did)
          </li>
          <li>Wrote a song for Justin Bieber</li>
          <li>
            Learn guitar and piano and singing as an adult, actually after I
            started to have hits!
          </li>
